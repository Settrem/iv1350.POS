 ...
 * It interacts with the {@code Controller} to simulate scanning items,
 * displaying
...
public class View {
     ...
     *
     * @param controller The controller that manages the application's logic and
     *                   data.
     */
    public View(Controller controller) {
        this.controller = controller;
        this.controller.addRevenueObserver(revenueView);
        this.controller.addRevenueObserver(revenueFile); 
    }

    /**
     * Starts the user interface loop for handling sales. Prompts the user to input
     * item IDs or the keyword "endsale" to complete the sale. Displays cart
     * contents
     ...
     * @return The value of endSale, which indicates whether a sale-ending condition
     *         has occurred.
     */
