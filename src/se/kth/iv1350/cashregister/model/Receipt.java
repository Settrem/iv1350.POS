...
public class Receipt {
    ...
    public Receipt(Sale sale, int cash) {
        ...
        this.receipt = this.receipt
                .concat(LocalDate.now() + " " + LocalTime.now().withSecond(0).withNano(0).toString() + "\n\n");
        ...
        for (int i = 0; i < cart.size(); i++) {
            ...
            currentLine = currentLine
                    .concat(currentEntry.getAmount() + " x " + currentEntry.itemDTO.getPriceWithVAT() / 100.0);
        ...
        this.receipt = this.receipt
                .concat("Vat:" + " ".repeat(width - totalString.length() - 9) + vatString + " SEK\n");
